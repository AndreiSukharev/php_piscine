...
class Matrix
{
    ...
    {
        $this->identity(1);
        $this->matrix[3] = $this->_vtc->_z;
        $this->matrix[7] = $this->_vtc->_z;
    ...
    {
        $tmp = array();
        $tmp['x'] = ($vtx->_x * $this->matrix[0]) + ($vtx->_y * $this->matrix[1]) +
            ($vtx->_z * $this->matrix[2]) + ($vtx->_w * $this->matrix[3]);
        $tmp['y'] = ($vtx->_x * $this->matrix[4]) + ($vtx->_y * $this->matrix[5]) +
            ($vtx->_z * $this->matrix[6]) + ($vtx->_w  * $this->matrix[7]);
        $tmp['z'] = ($vtx->_x * $this->matrix[8]) + ($vtx->_y * $this->matrix[9]) +
            ($vtx->_z * $this->matrix[10]) + ($vtx->_w  * $this->matrix[11]);
        $tmp['w'] = ($vtx->_x * $this->matrix[11]) + ($vtx->_y * $this->matrix[13]) +
            ($vtx->_z * $this->matrix[14]) + ($vtx->_w  * $this->matrix[15]);
